...
class Model(ModelDesc):
    ...
    def build_graph(self, image, label):
        ...
        def residual(name, l, m, v, increase_dim=False, first=False):
            ...
            with tf.variable_scope(name):
                if first: 
                    ...
                    b1, m1, v1 = KN('kn', l, m, v, split_num = split_num, p_rate = 0.05)
                    b1 = tf.nn.relu(b1)
                ...
                c1, m2, v2 = KN('kn1', c1, m1, v1, split_num = split_num, p_rate = 0.05)
        ...
        with argscope([Conv2D, AvgPooling, BatchNorm, GlobalAvgPooling], data_format='channels_last'), \
            ...
            l, m, v = KN('kn0', l, None, None, split_num = split_num, p_rate = 0.05)
            ...
            l, _, _ = KN('knlast', l, m, v, split_num = split_num, p_rate = 0.05)
            l = tf.nn.relu(l)
            # 8,c=64
